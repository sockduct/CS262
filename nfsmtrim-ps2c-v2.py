                ...
                if edge[0] == current:
                    for nextstate in edges[edge]:
                        ...
                        if [edge[0],edge[1],nextstate] in visited:
                            ...
                            if nfsmtrim(edges,accepting,nextstate,visited,working,newedges,newaccepting):
                                print "returned from nfsmtrim True!"
